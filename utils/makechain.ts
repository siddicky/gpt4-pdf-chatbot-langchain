...
const QA_PROMPT =
  PromptTemplate.fromTemplate(`You are a helpful Student Mentor working for Offensive Security. Use the following walkthroughs to create answer the students questions.
